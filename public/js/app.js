...
var league = 1;
var totalWeeks = await getTotalWeeks();
...
function generateResultOfWeek(week) {
  ...
  var weekContainerHTML = '<div class="week-container" data-week="' + week + '">' + '<div class="week-table" id="week-results-' + week + '">' + '</div>' + '<div class="week-predictions" id="week-predictions-' + week + '">' + '</div>' + '<div class="md:max-lg:flex">' + '<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded play-week" data-week="' + week + '">Play Week ' + week + '</button>' + '</div>' + '</div>';
...
function resetMatches() {
  ...
  $.ajax({
    ...
    url: '/reset-league/' + league,
    // Replace with the appropriate route for resetLeague method
    type: 'POST',
    dataType: 'json',
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      $.each(response.data.standings, function (index, team) {
        standingsTable += '<tr>' + '<td>' + team.team_name + '</td>' + '<td>' + team.played + '</td>' + '<td>' + team.won + '</td>' + '<td>' + team.lost + '</td>' + '<td>' + team.draw + '</td>' + '<td>' + team.points + '</td>' + '<td>' + team.goal_difference + '</td>' + '</tr>';
      });
...
function loadWeekResults(week) {
  $.ajax({
    url: '/week-results/' + league + '/' + week,
    // Replace with the appropriate route for fetching week results
    type: 'GET',
    dataType: 'json',
    success: function success(response) {
      ...
      $.each(response.data.matches, function (index, match) {
        weekResultsTable += '<tr data-match-id="' + match.id + '">' + '<td>' + match.home_team.name + '</td>' + '<td>' + match.away_team.name + '</td>' + '<td class="editable">' + match.home_team_goals + '</td>' + '<td class="editable">' + match.away_team_goals + '</td>' + '<td><button class="edit-result">Edit</button><button class="save-result" style="display: none;">Save</button></td>' + '</tr>';
      });
...
function loadWeekPredictions(week) {
  $.ajax({
    ...
    // Replace with the appropriate route for fetching week predictions
    type: 'GET',
    dataType: 'json',
    success: function success(response) {
      ...
      $.each(response.data.predictions.predictions[week], function (index, prediction) {
        weekPredictionsTable += '<tr>' + '<td>' + prediction.team_name + '</td>' + '<td>' + prediction.team_prediction + '%</td>' + '</tr>';
      });
...
$(document).on('click', '.save-result', function () {
  ...
  $.ajax({
    ...
    success: function success(response) {
      var currentWeek = parseInt($clickedButton.closest('.week-container').data('week'));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkinsider"] = self["webpackChunkinsider"] || [];
